...
import com.blankcat.teva.ui.coupons.components.CouponCompostable
    ...
    Column {
        ...
        LazyVerticalGrid(
            ...
            items(searchResults.value) {
                CouponCompostable(
                    it,
                    deleteCoupon = { viewModel.deleteCoupon(it) },
                    updateCoupon = {
                        barcode = it
...
if (showModalBottomSheet) {
    AddItemModalSheet(
        ...
        addBarcode = { viewModel.addCoupon(it) },
